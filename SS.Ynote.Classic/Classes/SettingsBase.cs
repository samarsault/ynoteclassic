...
public static class SettingsBase
{
    ...
    ///     Key Binding
    /// </summary>
    public static string KeyBinding { get; set; }
    ...
    ///     Show Menu Bar
    /// </summary>
    public static bool ShowMenuBar { get; set; }
    /// <summary>
    ///     Get The FontFamily
    /// </summary>
    ...
    {
        IConfigSource source = new IniConfigSource(Application.StartupPath + @"\User\Settings.ini");
        ThemeFile = source.Configs["Ynote"].Get("ThemeFile");
        KeyBinding = source.Configs["Ynote"].Get("KeyBinding");
    ...
    {
        var source = new IniConfigSource(Application.StartupPath + @"\User\Settings.ini");
        source.Configs["Ynote"].Set("ThemeFile", ThemeFile);
        source.Configs["Ynote"].Set("KeyBinding", KeyBinding);
        ...
        source.Save(Application.StartupPath + @"\User\Settings.ini");
    }
    ...
    public static void RestoreDefault(string configfile)
    {
        ...
        config.Set("KeyBinding", Application.StartupPath + @"\User\KeyBindigs\Default.ynotekeymap
");
        config.Set("ShowHiddenCharacters", false);
        config.Set("DocumentStyle", DocumentStyle.DockingSdi);
