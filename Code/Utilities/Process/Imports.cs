...
namespace ConsoleControlAPI
{
    internal static class Imports
    {
        ...
        ///     The identifier of the process group to receive the signal. A process group is created when the
        ///     CREATE_NEW_PROCESS_GROUP flag is specified in a call to the CreateProcess function. The process identifier of the
        ///     new process is also the process group identifier of a new process group. The process group includes all processes
        ///     that are descendants of the root process. Only those processes in the group that share the same console as the
        ///     calling process receive the signal. In other words, if a process in the group creates a new console, that process
