    ...
    internal class VS2012LightDockPaneStrip : DockPaneStripBase
    {
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            else
            {
                ...
                if (tabActive != null && DockPane.IsActiveDocumentPane)
                    ...
                    tabUnderLineColor =
                        DockPane.DockPanel.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.EndColor;

                g.DrawLine(new Pen(tabUnderLineColor, 4), rectTabStrip.Left, rectTabStrip.Bottom, rectTabStrip.Right,
                    rectTabStrip.Bottom);
            }
        ...
        private void DrawTab_ToolWindow(Graphics g, TabVS2012Light tab, Rectangle rect)
        {
            ...
            else
            {
                ...
                if (tab.Content == DockPane.MouseOverTab)
                    ...
                    textColor =
                        DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.TextColor;
        ...
        private void DrawTab_Document(Graphics g, TabVS2012Light tab, Rectangle rect)
        {
            ...
            Color mouseHoverColor =
                DockPane.DockPanel.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.EndColor;
            ...
            if (DockPane.ActiveContent == tab.Content)
            {
                if (DockPane.IsActiveDocumentPane)
                {
                    ...
                    TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectText, activeText,
                        DocumentTextFormat);
                    g.DrawImage(
                        rectCloseButton == ActiveClose ? Resources.ActiveTabHover_Close : Resources.ActiveTab_Close,
                        rectCloseButton);
                }
                else
                {
                    g.FillRectangle(new SolidBrush(lostFocusColor), rect);
                    TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectText, lostFocusText,
                        DocumentTextFormat);
                    g.DrawImage(
                        rectCloseButton == ActiveClose
                            ? Resources.LostFocusTabHover_Close
                            : Resources.LostFocusTab_Close, rectCloseButton);
                }
            }
            else
            {
                if (tab.Content == DockPane.MouseOverTab)
                {
                    ...
                    g.DrawImage(
                        rectCloseButton == ActiveClose
                            ...
                            : Resources.ActiveTabHover_Close, rectCloseButton);
                }
                else
                {
                    g.FillRectangle(new SolidBrush(inactiveColor), rect);
                    TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectText, inactiveText,
                        DocumentTextFormat);
                }
            }
